# Example referenced from the website: http://blog.csdn.net/marsjhao/article/details/68950697
...
with tf.Session() as sess:
    ...
    # use the trained encoder to encode and then decode to see how similar
